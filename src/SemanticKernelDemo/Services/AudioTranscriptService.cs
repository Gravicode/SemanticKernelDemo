...
namespace SemanticKernelDemo.Services
{
    public class AudioTranscriptService
    {
        ...
        public AudioTranscriptService(IOpenAIService service)
        {
            this.openAiService = service;
        }

       
        public async Task<string> TranscriptAudio(byte[] AudioData, string Filename, CancellationToken cancellationToken = default)
        {
