    ...
    */
    ...
    canvas.dispatchEvent(new CustomEvent('regiondrawn', {
        ...
        detail: {
            ...
            sourceImage: returnArray(imageArrayBuffer),//DotNet.createJSObjectReference(readable(imageArrayBuffer)),
            selectedRegion: returnArray(selectionArrayBuffer) //DotNet.createJSObjectReference(readable(selectionArrayBuffer)),
        }
    }));
}
